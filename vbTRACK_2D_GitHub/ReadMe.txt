...
5. One dataset, the track of an RNP particle following VSV infection of a a live mammalian A549 cell,  is provided to demonstrate the program.  Only the machine-learning part of our code is provided here. The code generates 5 figures:
